USE [master]
GO
/****** Object:  Database [DB_PSYCO]    Script Date: 06/09/2024 21:11:04 ******/
CREATE DATABASE [DB_PSYCO]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DB_PSYCO', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\DB_PSYCO.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'DB_PSYCO_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\DB_PSYCO_log.ldf' , SIZE = 3520KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
...
begin
EXEC [DB_PSYCO].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
...
GO
ALTER DATABASE [DB_PSYCO] SET AUTO_CLOSE OFF 
GO
...
GO
ALTER DATABASE [DB_PSYCO] SET CURSOR_DEFAULT  GLOBAL 
GO
...
GO
ALTER DATABASE [DB_PSYCO] SET  DISABLE_BROKER 
GO
ALTER DATABASE [DB_PSYCO] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [DB_PSYCO] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [DB_PSYCO] SET TRUSTWORTHY OFF 
GO
...
GO
ALTER DATABASE [DB_PSYCO] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [DB_PSYCO] SET RECOVERY FULL 
GO
ALTER DATABASE [DB_PSYCO] SET  MULTI_USER 
GO
ALTER DATABASE [DB_PSYCO] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [DB_PSYCO] SET DB_CHAINING OFF 
GO
ALTER DATABASE [DB_PSYCO] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [DB_PSYCO] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [DB_PSYCO] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [DB_PSYCO] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'DB_PSYCO', N'ON'
GO
ALTER DATABASE [DB_PSYCO] SET QUERY_STORE = OFF
GO
USE [DB_PSYCO]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_DesencriptarPassword]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[fn_EncriptarPassword]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  Table [dbo].[tbl_centros_atencion]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_cita]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_encuesta]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_estados_cita]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_flujos]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_historial_paciente]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_invitados]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_menu]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_meses]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_opciones_usuario]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_puntos_visitados]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_resumen_flujo]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_tickets]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_tipolinea]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_tipousuario]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_usuario]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[tbl_visitas]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[tbl_cita] ([id_cita], [id_usuario], [fecha_cita], [hora_cita], [id_doctor_asignado], [id_estado_cita], [fecha_registro], [tipo]) VALUES (31, 2, CAST(N'2024-09-09' AS Date), CAST(N'11:00:00' AS Time), 4, 1, CAST(N'2024-09-06T20:44:38.170' AS DateTime), N'CITA')
GO
...
GO
INSERT [dbo].[tbl_encuesta] ([id_item], [id_usuario], [puntuacion], [hora], [fecha], [resultado]) VALUES (13, 2, 10, N'11:40:27', N'2024-09-06', N'Promotor')
GO
...
GO
INSERT [dbo].[tbl_flujos] ([id_flujo], [id_usuario], [tipo], [contenido_texto], [contenido_html], [habilitado], [remitente]) VALUES (1186, 2, N'text', N'hola', N'<li class="reverse"><div class="chat-time">20:43</div><div class="chat-content"><div class="box bg-light-inverse">hola</div></div><div class="chat-img"><img src="https://localhost:44383/images/user.png" /></div></li>', 1, N'person')
GO
INSERT [dbo].[tbl_flujos] ([id_flujo], [id_usuario], [tipo], [contenido_texto], [contenido_html], [habilitado], [remitente]) VALUES (1187, 2, N'options_title', N'Hola somos el asistente virtual de la clinica ingrese la edad del paciente.', N'<li><div class="chat-img"><img src="https://localhost:44383/images/bot.jpg" class=""/></div><div class="chat-content"><div class="chat-content" style="margin-bottom: -10px;"><div class="box bg-light-success">Hola somos el asistente virtual de la clinica ingrese la edad del paciente.</div></div></div><div class="chat-time">20:43</div></li>', 1, N'bot')
GO
INSERT [dbo].[tbl_flujos] ([id_flujo], [id_usuario], [tipo], [contenido_texto], [contenido_html], [habilitado], [remitente]) VALUES (1188, 2, N'option', N'16-30 Meses,4 a 11 años,6 a 16 años', N'<li style="margin-top: 10px;"><div class="chat-img"><img src="https://localhost:44383/images/bot.jpg" class="invisible-element"/></div><div class="chat-content"><div class="chat-content chat-option" onclick="redirect_message(''Cuestionario1'',''16-30 Meses'')"><div class="box bg-light-info">16-30 Meses</div></div><div class="chat-content chat-option" onclick="redirect_message(''Cuestionario4'',''4 a 11 años'')"><div class="box bg-light-info">4 a 11 años</div></div><div class="chat-content chat-option" onclick="redirect_message(''Cuestionario3'',''6 a 16 años'')"><div class="box bg-light-info">6 a 16 años</div></div></div></li>', 1, N'bot')
GO
...
GO
INSERT [dbo].[tbl_resumen_flujo] ([id_item], [id_usuario], [resultado]) VALUES (17, 2, N'CUESTIONARIO_OK')
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_ACTUALIZAR_CONTRASEÑA]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_generar_ticket]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_CENTROS_ATENCION]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_CITAS_DOCTOR]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_CITAS_USUARIO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_DISPONIBILIDAD_DOCTOR]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_DOCTORES]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_ENCUESTAS]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_HISTORIAL_PACIENTE]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_LISTAR_MENU]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_PUNTOS_VISITADOS]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_CITA]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_CUESTIONARIO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_ESTADO_CUESTIONARIO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END  
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_FLUJO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_HISTORIAL_PACIENTE]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_INVITADO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_PUNTO_VISITADO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_PUNTUACION]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_TICKET]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_USUARIO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_REGISTRAR_VISITA]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_RESULTADOS_NPS]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_VALIDAR_FLUJO_ACTUAL]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[SP_VALIDAR_USUARIO]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[SP_VISITAS]    Script Date: 06/09/2024 21:11:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
